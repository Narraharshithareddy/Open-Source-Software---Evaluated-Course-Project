...
I’m **Harshitha** (`Narra Harshitha`, reg no `24MIM10005`). I wrote a few small shell scripts to pull basic system info, check package info, audit a couple of directories, and scan a log file for keyword matches.
...
From the repo directory (`https://github.com/Narraharshithareddy/Open-Source-Software---Evaluated-Course-Project.git`):
